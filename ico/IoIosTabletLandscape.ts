...
/**
 * IosTabletLandscape icon from Ionicons 4
 * @module
 */
export function IoIosTabletLandscape(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoIosTabletLandscape;
