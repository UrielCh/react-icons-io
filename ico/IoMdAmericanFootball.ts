...
/**
 * MdAmericanFootball icon from Ionicons 4
 * @module
 */
export function IoMdAmericanFootball(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoMdAmericanFootball;
