...
/**
 * IosArrowDropdownCircle icon from Ionicons 4
 * @module
 */
export function IoIosArrowDropdownCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoIosArrowDropdownCircle;
