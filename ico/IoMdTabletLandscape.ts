...
/**
 * MdTabletLandscape icon from Ionicons 4
 * @module
 */
export function IoMdTabletLandscape(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoMdTabletLandscape;
