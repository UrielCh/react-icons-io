...
/**
 * MdCheckboxOutline icon from Ionicons 4
 * @module
 */
export function IoMdCheckboxOutline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoMdCheckboxOutline;
