...
/**
 * IosBatteryCharging icon from Ionicons 4
 * @module
 */
export function IoIosBatteryCharging(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoIosBatteryCharging;
