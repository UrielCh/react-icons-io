...
/**
 * MdBatteryCharging icon from Ionicons 4
 * @module
 */
export function IoMdBatteryCharging(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoMdBatteryCharging;
