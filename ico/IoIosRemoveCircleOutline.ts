...
/**
 * IosRemoveCircleOutline icon from Ionicons 4
 * @module
 */
export function IoIosRemoveCircleOutline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoIosRemoveCircleOutline;
