...
/**
 * IosInformationCircle icon from Ionicons 4
 * @module
 */
export function IoIosInformationCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoIosInformationCircle;
