...
/**
 * IosCheckboxOutline icon from Ionicons 4
 * @module
 */
export function IoIosCheckboxOutline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoIosCheckboxOutline;
