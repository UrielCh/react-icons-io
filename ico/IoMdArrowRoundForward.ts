...
/**
 * MdArrowRoundForward icon from Ionicons 4
 * @module
 */
export function IoMdArrowRoundForward(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoMdArrowRoundForward;
