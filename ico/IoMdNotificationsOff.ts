...
/**
 * MdNotificationsOff icon from Ionicons 4
 * @module
 */
export function IoMdNotificationsOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoMdNotificationsOff;
