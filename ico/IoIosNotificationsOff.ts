...
/**
 * IosNotificationsOff icon from Ionicons 4
 * @module
 */
export function IoIosNotificationsOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoIosNotificationsOff;
