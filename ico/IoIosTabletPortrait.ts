...
/**
 * IosTabletPortrait icon from Ionicons 4
 * @module
 */
export function IoIosTabletPortrait(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default IoIosTabletPortrait;
